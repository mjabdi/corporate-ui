    ...
    const LoadData = (date) => {
      ...
      Promise.all([promise1])
        .then((values) => {
          ...
          if (state.cat.text && state.cat.text === "Embassy Staff") {

            if (getDay(state.bookingDate) === 4)
            {
              timeSlotsTmp.forEach((time) => {
                if (time.time === "01:00 PM"  || time.time === "01:15 PM" ||  time.time === "01:30 PM" 
                || time.time === "01:45 PM" || time.time === "02:00 PM" || time.time === "02:15 PM" 
                || time.time === "02:30 PM" || time.time === "02:45 PM" || time.time === "03:00 PM"
                || time.time === "03:15 PM" || time.time === "03:30 PM"
                || time.time === "03:45 PM" || time.time === "04:00 PM" || time.time === "04:15 PM" || time.time === "04:30 PM"
                    || time.time === "04:45 PM" || time.time === "05:00 PM" || time.time === "05:15 PM" || time.time === "05:30 PM"
                )
                {
                  time.available = false;
                }
